...
### Endpoint Discovery
- **URL**: `http://172.24.1.33/api/discover`
- **Metodo**: POST
- **Payload**: `{"network": "10.10.4.0/24"}`
- **Community SNMP**: "gsmon" (hardcoded)
...
124;PDV_Milano;10.10.4.0/24;admin;pass123;10.10.4.251;admin_core;pass_core
```
